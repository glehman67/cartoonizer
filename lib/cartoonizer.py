...
class Cartoonizer: 
    ...
    def __init__(self): 
        pass
    def render(self, file_bytes, d, sigmaColor, sigmaSpace, blur_ksize, blockSize, C, numDownSamples, numBilateralFilters):
        ...
        for _ in range(numBilateralFilters): 
                img_color = cv2.bilateralFilter(img_color, d, sigmaColor, sigmaSpace) 
